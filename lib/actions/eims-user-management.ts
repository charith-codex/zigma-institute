...
const ensureAuthorized = async (): Promise<BaseActionResult<PermittedRole>> => {
  ...
  if (!session?.user?.role || !permittedRoles.includes(session.user.role as PermittedRole)) {
    return {
      success: false,
...
export async function createStudent(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof z.ZodError ? error.issues[0]?.message ?? "Invalid input." : "Failed to create student.",
    };
  }
}
...
export async function updateStudent(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof z.ZodError ? error.issues[0]?.message ?? "Invalid input." : "Failed to update student.",
    };
  }
}

export async function deleteStudent(id: string): Promise<BaseActionResult<null>> {
  const authorization = await ensureAuthorized();
  if (!authorization.success) {
    return authorization;
  }
...
export async function listTeachers(): Promise<BaseActionResult<TeacherRecord[]>> {
  const authorization = await ensureAuthorized();
  if (!authorization.success) {
    return authorization;
  }
...
export async function createTeacher(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof z.ZodError ? error.issues[0]?.message ?? "Invalid input." : "Failed to create teacher.",
    };
  }
}
...
export async function updateTeacher(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof z.ZodError ? error.issues[0]?.message ?? "Invalid input." : "Failed to update teacher.",
    };
  }
}

export async function deleteTeacher(id: string): Promise<BaseActionResult<null>> {
  const authorization = await ensureAuthorized();
  if (!authorization.success) {
    return authorization;
  }
...
export async function createStaff(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof z.ZodError ? error.issues[0]?.message ?? "Invalid input." : "Failed to create staff member.",
    };
  }
}
...
export async function updateStaff(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof z.ZodError ? error.issues[0]?.message ?? "Invalid input." : "Failed to update staff member.",
    };
  }
}
...
export type { StudentRecord, TeacherRecord, StaffRecord };
