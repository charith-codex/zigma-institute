...
const courseHighlights = [
  {
    ...
    copy: "Small group instruction by live dashboards so mentors react fast to progress spikes or dips.",
    icon: Users,
  },
  {
    title: "Layered content",
    copy: "Lessons, labs, and past papers stay synced across LMS, CMS, and EIMS.",
    icon: Layers3,
  },
  {
    title: "Adaptive schedules",
    copy: "Weekday, weekend, and evening blocks that flex around, exams, and travel plans.",
    icon: CalendarRange,
  },
];
        ...
        <section className="px-6 py-12 text-center md:px-10">
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              All Courses with Modern Educational Experience
            </h1>
        ...
        <section className="space-y-8">
          <div className="max-w-2xl space-y-3">
            ...
            <p className="text-muted-foreground">
              Minimal noise, clear milestones and modern learning experience.
            </p>
          </div>
