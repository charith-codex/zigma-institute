...
export default async function SignInPage(props: {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-blue-600 via-purple-600 to-indigo-800">
        {/* Floating 3D cubes */}
        ...
        <div className="absolute top-20 right-20 hidden lg:block">
          <div className="relative transform perspective-1000">
            {/* Main backpack body */}
            <div className="w-16 h-20 bg-linear-to-r from-purple-600 to-purple-800 rounded-lg shadow-2xl transform rotateY-15"></div>
            {/* Backpack straps */}
            ...
            {/* Front pocket */}
            <div className="absolute inset-x-2 top-4 bottom-6 bg-linear-to-r from-purple-500 to-purple-700 rounded-md shadow-inner"></div>
          </div>
        </div>
      </div>
