        ...
        <Body className="bg-slate-50 font-sans">
          <Container className="mx-auto my-10 max-w-xl rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <Text className="mt-3 text-sm text-slate-600 leading-6">
              Your enrolment is confirmed and your learning workspace is ready.
              Use the credentials below to access the LMS immediately. We
              recommend changing the password after your first login.
            </Text>
            ...
            {idCardUrl && (
              <Section className="mt-6 rounded-lg bg-slate-100 p-4">
                ...
                <Text className="mt-2 text-sm font-medium text-slate-800">
                  We've attached your digital ID card to this email.
                </Text>
                <Text className="mt-2 text-xs text-slate-500">
                  Keep this digital ID saved or printed. You can present it for
                  onsite verification or attendance.
                </Text>
              </Section>
            )}
            {!idCardUrl && (
              <Section className="mt-6 rounded-lg bg-amber-50 p-4 border border-amber-200">
                ...
                <Text className="mt-2 text-xs text-amber-600">
                  Your student ID card is being processed and will be emailed to
                  you shortly. You can also download it from the student portal
                  once available.
                </Text>
              </Section>
            )}
            <Section className="mt-6">
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-600">
                {courses.length > 0 ? (
                  ...
                  <li>
                    Your course list will be available after your first login.
                  </li>
                )}
              </ul>
            </Section>
            ...
            <Text className="text-xs text-slate-500 leading-5">
              Need help? Reply to this email or reach us on +94 11 222 3344. We
